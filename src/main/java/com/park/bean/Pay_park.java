...
public class Pay_park implements Cloneable , Serializable{
    ...
    public Date arrive_time=new Date();//datetime    到场时间
    public Date leave_time=new Date();//datetime    离场时间
    ...
    public void setLeave_time(Date value){
    	if(value == null){
           value = new Date();
        }
    ...
    public static Pay_park newPay_park(long id, long pi_id, long ui_id, String car_code, int money, int pp_state, Date ctime, Date utime, int pay_source, String my_order, String other_order, int pay_type, String pp_versioncode, int phone_type, int order_type, int allege_state, int expect_time, Date arrive_time, Date leave_time, int expect_money, String expect_info, String area_code, int is_expect_outtime, int is_expect_deduct, int start_price, int start_time, int charging, int charging_time, int is_del, long upc_id, long discount_money, String note, String discount_name, int discount_type, int final_time, String address_name, int cancel_state, int is_open, Date open_time, int is_cash, int park_type, Date scan_time, String pi_name, int is_over, int free_minute, int is_free_minute, long pu_id, String pu_nd, double lng, double lat, int expect_state, String ui_nd, long ai_id, int ai_money, int ai_effect, String ui_tel, int magnetic_state, String gov_num, Date stime, String up_orderid, long close_time, int sure_type) {
    ...
    public void assignment(Pay_park pay_park) {
        ...
        Date ctime = pay_park.getCtime();
        Date utime = pay_park.getUtime();
        ...
        Date arrive_time = pay_park.getArrive_time();
        Date leave_time = pay_park.getLeave_time();
        ...
        Date open_time = pay_park.getOpen_time();
        int is_cash = pay_park.getIs_cash();
        int park_type = pay_park.getPark_type();
        Date scan_time = pay_park.getScan_time();
