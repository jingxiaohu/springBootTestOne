...
public class Fault_record implements Cloneable , Serializable{
    ...
    public static Fault_record newFault_record(long fr_id, long pi_id, long pd_id, int fr_type, String fr_desc, Date ctime, Date utime, String area_code, String note) {
    ...
    public void assignment(Fault_record fault_record) {
        ...
        Date ctime = fault_record.getCtime();
        Date utime = fault_record.getUtime();
