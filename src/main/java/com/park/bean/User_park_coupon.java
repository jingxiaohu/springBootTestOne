...
public class User_park_coupon implements Cloneable , Serializable{
    ...
    public static User_park_coupon newUser_park_coupon(long upc_id, long ui_id, long pc_id, int money, double discount, int high_money, int upc_type, Date end_time, int upc_state, Date ctime, Date utime, String note, int send_unit, long ai_id, int state) {
    ...
    public void assignment(User_park_coupon user_park_coupon) {
        ...
        Date end_time = user_park_coupon.getEnd_time();
        int upc_state = user_park_coupon.getUpc_state();
        Date ctime = user_park_coupon.getCtime();
        Date utime = user_park_coupon.getUtime();
