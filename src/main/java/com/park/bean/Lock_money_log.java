...
public class Lock_money_log implements Cloneable , Serializable{
    ...
    public static Lock_money_log newLock_money_log(long id, long ui_id, String ui_nd, int type, int state, int money, String orderid, int oder_type, long pi_id, String area_code, Date ctime, String note) {
    ...
    public void assignment(Lock_money_log lock_money_log) {
        ...
        Date ctime = lock_money_log.getCtime();
