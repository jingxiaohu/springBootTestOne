...
public class Activity_event implements Cloneable , Serializable{
    ...
    public Date utime=new Date();//datetime    处理时间
    ...
    public static Activity_event newActivity_event(long id, int type, long ui_id, String ui_nd, long pi_id, String pi_name, String area_code, String car_code, int order_type, String orderid, long ai_id, int money, Date ctime, int state, Date utime, int ai_money, String note, String md5, int send_unit, int act_type, String method_name, int pay_source) {
    ...
    public void assignment(Activity_event activity_event) {
        ...
        Date ctime = activity_event.getCtime();
        int state = activity_event.getState();
        Date utime = activity_event.getUtime();
