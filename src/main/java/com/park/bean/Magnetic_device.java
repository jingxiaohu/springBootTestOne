...
public class Magnetic_device implements Cloneable , Serializable{
    ...
    public Date ptime=new Date();//datetime    上次推送时间
    ...
    public void setPtime(Date value){
    	if(value == null){
           value = new Date();
        }
        this.ptime= value;
    ...
    public static Magnetic_device newMagnetic_device(long id, long pi_id, String area_code, String gov_num, String car_dev_num, String android_dev_num, int state, Date ctime, Date utime, Date ptime, String note, int fault_count, int is_del) {
    ...
    public void assignment(Magnetic_device magnetic_device) {
        ...
        Date ctime = magnetic_device.getCtime();
        Date utime = magnetic_device.getUtime();
        Date ptime = magnetic_device.getPtime();
