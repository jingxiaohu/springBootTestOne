...
public class Activity_info implements Cloneable , Serializable{
    ...
    public Date starttime=new Date();//datetime    活动开始时间
    public Date endtime=new Date();//datetime    活动结束时间
    ...
    public Date coupon_endtime=new Date();//datetime    送券到期时间
    ...
    public void setCoupon_endtime(Date value){
    	if(value == null){
           value = new Date();
        }
    ...
    public static Activity_info newActivity_info(long ai_id, String title, String intro, long money, int type, Date starttime, Date endtime, Date ctime, Date utime, String admin_loginname, long admin_id, String partner, int people_num, String note, int state, long pi_id, String area_code, long pc_id, int weight, String pi_name, String img, String img_jump_url, Date coupon_endtime) {
    ...
    public void assignment(Activity_info activity_info) {
        ...
        Date starttime = activity_info.getStarttime();
        Date endtime = activity_info.getEndtime();
        Date ctime = activity_info.getCtime();
        Date utime = activity_info.getUtime();
        ...
        Date coupon_endtime = activity_info.getCoupon_endtime();
