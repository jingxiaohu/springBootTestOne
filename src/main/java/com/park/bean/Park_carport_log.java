...
public class Park_carport_log implements Cloneable , Serializable{
    ...
    public Date ctime=new Date();//datetime    停车场本地时间
    public Date stime=new Date();//datetime    接收数据时间
    ...
    public static Park_carport_log newPark_carport_log(long pcl_id, long pi_id, String area_code, int carport_total, int carport_yet, int carport_space, int park_type, int data_flag, Date ctime, Date stime, String note) {
    ...
    public void assignment(Park_carport_log park_carport_log) {
        ...
        Date ctime = park_carport_log.getCtime();
        Date stime = park_carport_log.getStime();
