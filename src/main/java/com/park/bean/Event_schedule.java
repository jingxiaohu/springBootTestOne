...
public class Event_schedule implements Cloneable , Serializable{
    ...
    public static Event_schedule newEvent_schedule(long es_id, String event_name, int event_type, String up_orderid, String order_id, int order_type, long ui_id, String ui_nd, long pi_id, String area_code, Date ctime, Date utime, int state, String note) {
    ...
    public void assignment(Event_schedule event_schedule) {
        ...
        Date ctime = event_schedule.getCtime();
        Date utime = event_schedule.getUtime();
