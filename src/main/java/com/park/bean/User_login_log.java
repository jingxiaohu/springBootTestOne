...
public class User_login_log implements Cloneable , Serializable{
    ...
    public static User_login_log newUser_login_log(long id, long ui_id, Date ctime, Date utime, String lng, String lat, int flag, String ull_ip, String note) {
    ...
    public void assignment(User_login_log user_login_log) {
        ...
        Date ctime = user_login_log.getCtime();
        Date utime = user_login_log.getUtime();
