...
public class Pda_owe_order_cover implements Cloneable , Serializable{
    ...
    public static Pda_owe_order_cover newPda_owe_order_cover(long pooc_id, String pooc_nd, String car_code, String order_id, long old_pi_id, String old_area_code, long old_pu_id, String old_pu_nd, String old_mac, long now_pi_id, String now_area_code, long now_pu_id, String now_pu_nd, String now_mac, long money, Date ctime, Date utime, int state, long old_ui_id, String old_uuid, long now_ui_id, String now_uuid, String note, int pay_source) {
    ...
    public void assignment(Pda_owe_order_cover pda_owe_order_cover) {
        ...
        Date ctime = pda_owe_order_cover.getCtime();
        Date utime = pda_owe_order_cover.getUtime();
