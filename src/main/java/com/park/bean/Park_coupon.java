...
public class Park_coupon implements Cloneable , Serializable{
    ...
    public Date end_time=new Date();//datetime    有效期到期时间
    ...
    public static Park_coupon newPark_coupon(long id, String name, int money, double discount, int high_money, Date end_time, int use_range, int pc_type, Date ctime, Date utime, String note, long ai_id) {
    ...
    public void assignment(Park_coupon park_coupon) {
        ...
        Date end_time = park_coupon.getEnd_time();
        int use_range = park_coupon.getUse_range();
        int pc_type = park_coupon.getPc_type();
        Date ctime = park_coupon.getCtime();
        Date utime = park_coupon.getUtime();
