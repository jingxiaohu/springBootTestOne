...
//finger_userinfo_new2
@SuppressWarnings({"serial"})
public class Finger_userinfo_new2 implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_new2 newFinger_userinfo_new2(long fu_id, String fu_nd, String ui_tel, long ui_id, String ui_nd, String name, String sfz_number, String sfz_img_url, String sfz_img_back_url, int state, int is_del, Date ctime, Date utime, String mac, long gather_id, String note, int fingerprint_state, int finger_veno_state) {
        Finger_userinfo_new2 ret = new Finger_userinfo_new2();
        ret.setFu_id(fu_id);
        ret.setFu_nd(fu_nd);
    ...
    public void assignment(Finger_userinfo_new2 finger_userinfo_new2) {
        long fu_id = finger_userinfo_new2.getFu_id();
        String fu_nd = finger_userinfo_new2.getFu_nd();
        String ui_tel = finger_userinfo_new2.getUi_tel();
        long ui_id = finger_userinfo_new2.getUi_id();
        String ui_nd = finger_userinfo_new2.getUi_nd();
        String name = finger_userinfo_new2.getName();
        String sfz_number = finger_userinfo_new2.getSfz_number();
        String sfz_img_url = finger_userinfo_new2.getSfz_img_url();
        String sfz_img_back_url = finger_userinfo_new2.getSfz_img_back_url();
        int state = finger_userinfo_new2.getState();
        int is_del = finger_userinfo_new2.getIs_del();
        Date ctime = finger_userinfo_new2.getCtime();
        Date utime = finger_userinfo_new2.getUtime();
        String mac = finger_userinfo_new2.getMac();
        long gather_id = finger_userinfo_new2.getGather_id();
        String note = finger_userinfo_new2.getNote();
        int fingerprint_state = finger_userinfo_new2.getFingerprint_state();
        int finger_veno_state = finger_userinfo_new2.getFinger_veno_state();
    ...
    public static void getFinger_userinfo_new2(Finger_userinfo_new2 finger_userinfo_new2 ){
        long fu_id = finger_userinfo_new2.getFu_id();
        String fu_nd = finger_userinfo_new2.getFu_nd();
        String ui_tel = finger_userinfo_new2.getUi_tel();
        long ui_id = finger_userinfo_new2.getUi_id();
    ...
    public static Map<String,Object> toEnMap(Finger_userinfo_new2 finger_userinfo_new2){
        long fu_id = finger_userinfo_new2.getFu_id();
        String fu_nd = finger_userinfo_new2.getFu_nd();
        String ui_tel = finger_userinfo_new2.getUi_tel();
        long ui_id = finger_userinfo_new2.getUi_id();
    ...
    public Finger_userinfo_new2 clone2(){
        try{
            return (Finger_userinfo_new2) this.clone();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
