...
public class Random_coupon_log implements Cloneable , Serializable{
    ...
    public static Random_coupon_log newRandom_coupon_log(long rcl_id, String nd, String car_code, int money, long upc_id, int type, long pi_id, String pi_name, String area_code, String orderid, int order_type, String partner, Date ctime, String note, long ai_id, long ui_id, String ui_nd, long ae_id, int send_unit, int act_type, int pay_source) {
    ...
    public void assignment(Random_coupon_log random_coupon_log) {
        ...
        Date ctime = random_coupon_log.getCtime();
