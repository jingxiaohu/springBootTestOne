...
public class Finger_userinfo_carcode2 implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_carcode2 newFinger_userinfo_carcode2(long fuc_id, long fu_id, String fu_nd, String sfz_number, String car_code, int is_run, int isi_del, Date ctime, Date utime, String note) {
    ...
    public void assignment(Finger_userinfo_carcode2 finger_userinfo_carcode2) {
        ...
        Date ctime = finger_userinfo_carcode2.getCtime();
        Date utime = finger_userinfo_carcode2.getUtime();
