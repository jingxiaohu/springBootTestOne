...
public class User_info implements Cloneable , Serializable{
    ...
    public Date ctime=new Date();//datetime
    public Date utime=new Date();//datetime
    ...
    public void assignment(User_info user_info) {
        ...
        Date ctime = user_info.getCtime();
        Date utime = user_info.getUtime();
