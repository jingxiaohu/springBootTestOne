...
public class Finger_userinfo implements Cloneable , Serializable{
    ...
    public Date signtime=new Date();//datetime    签约时间
    public Date discard_time=new Date();//datetime    解除签约时间
    ...
    public void setDiscard_time(Date value){
    	if(value == null){
           value = new Date();
        }
    ...
    public static Finger_userinfo newFinger_userinfo(long fu_id, String fu_nd, String ui_tel, long ui_id, String ui_nd, String name, String sfz_number, String sfz_img_url, String fingerprint, String bank_card_number, int bank_type, String orderid, int verify_sign, int state, int is_del, Date ctime, Date utime, String mac, long gather_id, int is_sign, String sign_ip, Date signtime, Date discard_time, int is_default, String note, String car_code, String finger_veno, String fingerprint_hash, String finger_veno_hash) {
    ...
    public void assignment(Finger_userinfo finger_userinfo) {
        ...
        Date ctime = finger_userinfo.getCtime();
        Date utime = finger_userinfo.getUtime();
        ...
        Date signtime = finger_userinfo.getSigntime();
        Date discard_time = finger_userinfo.getDiscard_time();
