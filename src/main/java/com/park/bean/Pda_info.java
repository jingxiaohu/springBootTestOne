...
public class Pda_info implements Cloneable , Serializable{
    ...
    public static Pda_info newPda_info(long pda_id, String mac, String pda_sn, String plate_license, String loginname, String password, long pi_id, String area_code, long pu_id, String pu_nd, Date ctime, Date utime, String note, int is_initialize, double lng, double lat, String pi_name, long pda_c_id, int vnum, String token) {
    ...
    public void assignment(Pda_info pda_info) {
        ...
        Date ctime = pda_info.getCtime();
        Date utime = pda_info.getUtime();
