...
public class Parkinfo_monthfree implements Cloneable , Serializable{
    ...
    public Date stime=new Date();//datetime    服务器端创建时间
    ...
    public void assignment(Parkinfo_monthfree parkinfo_monthfree) {
        ...
        Date ctime = parkinfo_monthfree.getCtime();
        Date utime = parkinfo_monthfree.getUtime();
        ...
        Date stime = parkinfo_monthfree.getStime();
