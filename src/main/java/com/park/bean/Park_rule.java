...
public class Park_rule implements Cloneable , Serializable{
    ...
    public Date ctime=new Date();//datetime    服务器接受该数据时间
    public Date utime=new Date();//datetime    规则修改时间
    ...
    public static Park_rule newPark_rule(long pr_id, String pr_nd, long pi_id, String area_code, int state, String json_array, Date ctime, Date utime, String note) {
    ...
    public void assignment(Park_rule park_rule) {
        ...
        Date ctime = park_rule.getCtime();
        Date utime = park_rule.getUtime();
