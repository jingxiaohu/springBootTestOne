...
public class User_park_coupon_log implements Cloneable , Serializable{
    ...
    public Date end_time=new Date();//datetime    有效期
    ...
    public Date rtime=new Date();//datetime    变更记录时间(该次变更的入库时间)
    ...
    public void setRtime(Date value){
    	if(value == null){
           value = new Date();
        }
        this.rtime= value;
    ...
    public static User_park_coupon_log newUser_park_coupon_log(long upcl_id, long upc_id, long ui_id, String ui_nd, long pc_id, int money, double discount, int high_money, int upc_type, Date end_time, int upc_state, Date ctime, Date utime, int send_unit, long ai_id, int state, String note, int type, Date rtime, long accept_ui_id, String accept_ui_nd) {
    ...
    public void assignment(User_park_coupon_log user_park_coupon_log) {
        ...
        Date end_time = user_park_coupon_log.getEnd_time();
        int upc_state = user_park_coupon_log.getUpc_state();
        Date ctime = user_park_coupon_log.getCtime();
        Date utime = user_park_coupon_log.getUtime();
        ...
        Date rtime = user_park_coupon_log.getRtime();
