...
public class Client_gate_rule implements Cloneable , Serializable{
    ...
    public static Client_gate_rule newClient_gate_rule(long cgr_id, String client_ruleid, long pi_id, String area_code, String group_id, int type, int money, int state, String str_json, String intro, String permit_time, Date ctime, Date utime, String client_loginname, String note, int is_del) {
    ...
    public void assignment(Client_gate_rule client_gate_rule) {
        ...
        Date ctime = client_gate_rule.getCtime();
        Date utime = client_gate_rule.getUtime();
