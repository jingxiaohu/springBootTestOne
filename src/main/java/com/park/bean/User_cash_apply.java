...
public class User_cash_apply implements Cloneable , Serializable{
    ...
    public Date ctime=new Date();//datetime    提现申请时间
    public Date utime=new Date();//datetime    打款时间
    ...
    public static User_cash_apply newUser_cash_apply(long id, long pu_id, int money, Date ctime, Date utime, String note, int state, String bank_no, String bank_name, String bank_sub_name, String name, String tel) {
    ...
    public void assignment(User_cash_apply user_cash_apply) {
        ...
        Date ctime = user_cash_apply.getCtime();
        Date utime = user_cash_apply.getUtime();
