...
public class Etc_userpay_record implements Cloneable , Serializable{
    ...
    public Date trade_time=new Date();//datetime    支付交易时间
    public int refund_state;//int(11)    是否进行了退款（0：没有退款1：退款成功2：退款失败）
    public Date refund_time=new Date();//datetime    退款行为发生时间
    ...
    public void setTrade_time(Date value){
    	if(value == null){
           value = new Date();
        }
    ...
    public void setRefund_time(Date value){
    	if(value == null){
           value = new Date();
        }
    ...
    public static Etc_userpay_record newEtc_userpay_record(long eur_id, String eur_nd, long eu_id, String eu_nd, long ui_id, String ui_nd, long pu_id, String pu_nd, long pi_id, String area_code, String order_id, int order_type, long money, int state, Date trade_time, int refund_state, Date refund_time, Date ctime, String note, String pi_name, int is_over, String pay_orderid) {
    ...
    public void assignment(Etc_userpay_record etc_userpay_record) {
        ...
        Date trade_time = etc_userpay_record.getTrade_time();
        int refund_state = etc_userpay_record.getRefund_state();
        Date refund_time = etc_userpay_record.getRefund_time();
        Date ctime = etc_userpay_record.getCtime();
