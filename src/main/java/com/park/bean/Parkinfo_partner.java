...
public class Parkinfo_partner implements Cloneable , Serializable{
    ...
    public static Parkinfo_partner newParkinfo_partner(long id, long pi_id, long pu_id, String pu_nd, Date ctime, Date utime, int is_effect, String area_code, String note, int clearing_type, double clearing_percentage, int clearing_base) {
    ...
    public void assignment(Parkinfo_partner parkinfo_partner) {
        ...
        Date ctime = parkinfo_partner.getCtime();
        Date utime = parkinfo_partner.getUtime();
