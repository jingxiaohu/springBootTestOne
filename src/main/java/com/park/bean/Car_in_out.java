...
public class Car_in_out implements Cloneable , Serializable{
    ...
    public static Car_in_out newCar_in_out(long cio_id, long pi_id, long pd_id, long ui_id, String car_code, int is_enter, String in_out, String in_out_code, Date ctime, Date utime, String area_code, String note, int car_type, int car_code_color, String order_id, int out_type, int is_rent, long rent_remain_time, int is_local_month, String ui_nd, String ui_tel, int is_sync, String gov_num, Date stime) {
    ...
    public void assignment(Car_in_out car_in_out) {
        ...
        Date ctime = car_in_out.getCtime();
        Date utime = car_in_out.getUtime();
        ...
        Date stime = car_in_out.getStime();
