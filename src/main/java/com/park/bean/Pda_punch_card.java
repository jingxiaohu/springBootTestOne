...
public class Pda_punch_card implements Cloneable , Serializable{
    ...
    public static Pda_punch_card newPda_punch_card(long ppc_id, String nd, long pi_id, String area_code, long pu_id, String pu_nd, String mac, int type, String ontime, String offtime, String loginname, int is_clearing, Date ctime, Date utime, String worker_name, String worker_no, long pda_user_id, String note) {
    ...
    public void assignment(Pda_punch_card pda_punch_card) {
        ...
        Date ctime = pda_punch_card.getCtime();
        Date utime = pda_punch_card.getUtime();
