...
public class Finger_userinfo_bank implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_bank newFinger_userinfo_bank(long fub_id, long fu_id, String fu_nd, String sfz_number, String bank_card_number, int bank_type, String orderid, int verify_sign, int state, int is_del, Date ctime, Date utime, int is_sign, String sign_ip, Date signtime, Date discard_time, int is_default, String note, String name) {
    ...
    public void assignment(Finger_userinfo_bank finger_userinfo_bank) {
        ...
        Date ctime = finger_userinfo_bank.getCtime();
        Date utime = finger_userinfo_bank.getUtime();
        int is_sign = finger_userinfo_bank.getIs_sign();
        String sign_ip = finger_userinfo_bank.getSign_ip();
        Date signtime = finger_userinfo_bank.getSigntime();
        Date discard_time = finger_userinfo_bank.getDiscard_time();
