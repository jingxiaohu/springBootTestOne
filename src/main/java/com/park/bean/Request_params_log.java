...
public class Request_params_log implements Cloneable , Serializable{
    ...
    public static Request_params_log newRequest_params_log(long id, String method_name, long duration, String params_json, Date ctime, String note, String reponse_json) {
    ...
    public void assignment(Request_params_log request_params_log) {
        ...
        Date ctime = request_params_log.getCtime();
