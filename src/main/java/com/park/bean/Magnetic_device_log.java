...
public class Magnetic_device_log implements Cloneable , Serializable{
    ...
    public static Magnetic_device_log newMagnetic_device_log(long id, long pi_id, String area_code, String gov_num, String car_dev_num, String android_dev_num, int state, Date ctime, String note, int carport_total, int carport_yet, int carport_space) {
    ...
    public void assignment(Magnetic_device_log magnetic_device_log) {
        ...
        Date ctime = magnetic_device_log.getCtime();
