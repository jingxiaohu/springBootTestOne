...
public class Park_userinfo implements Cloneable , Serializable{
    ...
    public static Park_userinfo newPark_userinfo(long pu_id, String nd, String name, String tel, String bank_no, String bank_name, String bank_sub_name, int pda_num, int money, Date ctime, Date utime, String loginname, String password, String note, long money_online, long money_offline, double kickback, int privilege_id, int error_count, String error_date, int clearing_type, double clearing_percentage, int clearing_base) {
    ...
    public void assignment(Park_userinfo park_userinfo) {
        ...
        Date ctime = park_userinfo.getCtime();
        Date utime = park_userinfo.getUtime();
