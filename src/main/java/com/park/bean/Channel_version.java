...
public class Channel_version implements Cloneable , Serializable{
    ...
    public static Channel_version newChannel_version(long cv_id, long pda_c_id, String version_out_show, int version_code, int is_trunk, int is_open, String apk_url, String md5, String intro, String name, Date ctime, Date utime, int is_force, String note) {
    ...
    public void assignment(Channel_version channel_version) {
        ...
        Date ctime = channel_version.getCtime();
        Date utime = channel_version.getUtime();
