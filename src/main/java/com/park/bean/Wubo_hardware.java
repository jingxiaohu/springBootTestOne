...
public class Wubo_hardware implements Cloneable , Serializable{
    ...
    public static Wubo_hardware newWubo_hardware(long wh_id, int type, String mac, String imei, int plant_type, int state, Date ctime, Date utime, String loginname, String name, String note, String batch_date, long channel_id, int version_code) {
    ...
    public void assignment(Wubo_hardware wubo_hardware) {
        ...
        Date ctime = wubo_hardware.getCtime();
        Date utime = wubo_hardware.getUtime();
