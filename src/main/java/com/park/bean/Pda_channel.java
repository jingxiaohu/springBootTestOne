...
public class Pda_channel implements Cloneable , Serializable{
    ...
    public static Pda_channel newPda_channel(long pda_c_id, String name, String intro, int is_open, long father_id, int is_delete, Date ctime, Date utime, String note) {
    ...
    public void assignment(Pda_channel pda_channel) {
        ...
        Date ctime = pda_channel.getCtime();
        Date utime = pda_channel.getUtime();
