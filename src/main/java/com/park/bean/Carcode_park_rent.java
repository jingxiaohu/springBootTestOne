...
public class Carcode_park_rent implements Cloneable , Serializable{
    ...
    public static Carcode_park_rent newCarcode_park_rent(long cpr_id, long pi_id, String area_code, String pi_name, int unit_price, Date starttime, Date endtime, Date stime, Date utime, long ui_id, String ui_nd, String car_code, String permit_time, int rent_type, int is_del, int is_expire, String note, String client_rule_id, String address_name, long rd_id, String client_father_orderid) {
    ...
    public void assignment(Carcode_park_rent carcode_park_rent) {
        ...
        Date starttime = carcode_park_rent.getStarttime();
        Date endtime = carcode_park_rent.getEndtime();
        Date stime = carcode_park_rent.getStime();
        Date utime = carcode_park_rent.getUtime();
