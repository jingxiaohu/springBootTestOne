...
public class Rabbitmq_push_fail implements Cloneable , Serializable{
    ...
    public static Rabbitmq_push_fail newRabbitmq_push_fail(long rpf_id, String rpf_nd, int server_code, int type, String content_json, int persistent_state, Date ctime, Date utime, int fail_count, int state, String name, String note, String exchange_name, String routing_key, String host_name, String content_md5) {
    ...
    public void assignment(Rabbitmq_push_fail rabbitmq_push_fail) {
        ...
        Date ctime = rabbitmq_push_fail.getCtime();
        Date utime = rabbitmq_push_fail.getUtime();
