...
public class User_carcode implements Cloneable , Serializable{
    ...
    public static User_carcode newUser_carcode(long uc_id, long ui_id, String car_code, Date ctime, Date utime, String run_url, int is_default, String car_brand, int uc_color, String note, String ui_nd, String ui_tel, String run_code) {
    ...
    public void assignment(User_carcode user_carcode) {
        ...
        Date ctime = user_carcode.getCtime();
        Date utime = user_carcode.getUtime();
