...
public class User_pay implements Cloneable , Serializable{
    ...
    public Date utime=new Date();//datetime    第三方回调时间
    public Date etime=new Date();//datetime    订单失效时间
    ...
    public void setEtime(Date value){
    	if(value == null){
           value = new Date();
        }
        this.etime= value;
    ...
    public static User_pay newUser_pay(long id, String order_id, String transaction_id, int type, int version_code, int system_type, String return_url, long ui_id, String ui_nd, long money, int act_type, Date ctime, Date utime, Date etime, int state, String ip, String referer, String subject, String note, String car_order_id, String tel, String escape_orderids) {
    ...
    public void assignment(User_pay user_pay) {
        ...
        Date ctime = user_pay.getCtime();
        Date utime = user_pay.getUtime();
        Date etime = user_pay.getEtime();
