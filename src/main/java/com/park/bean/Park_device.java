...
public class Park_device implements Cloneable , Serializable{
    ...
    public static Park_device newPark_device(long pd_id, long pi_id, String in_out, String in_out_code, String camera, String camera_mac, String signo_name, String solid_garage_mac, String solid_garage_sn, Date ctime, Date utime, String pd_md5, String note, String area_code) {
    ...
    public void assignment(Park_device park_device) {
        ...
        Date ctime = park_device.getCtime();
        Date utime = park_device.getUtime();
