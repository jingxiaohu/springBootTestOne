...
public class User_vc_act implements Cloneable , Serializable{
    ...
    public static User_vc_act newUser_vc_act(long id, long ui_id, String order_id, int order_type, int act_type, int money, Date ctime, int state, int is_add, String note, String act_name, String tel, String ui_nd, int pay_source, int discount_money, int discount_type, long upc_id) {
    ...
    public void assignment(User_vc_act user_vc_act) {
        ...
        Date ctime = user_vc_act.getCtime();
