...
public class Hardware_version_log implements Cloneable , Serializable{
    ...
    public static Hardware_version_log newHardware_version_log(long id, long device_id, String mac, String pda_sn, String device_name, int device_type, long pi_id, String area_code, String pi_name, Date ctime, Date utime, int vnum, String note) {
    ...
    public void assignment(Hardware_version_log hardware_version_log) {
        ...
        Date ctime = hardware_version_log.getCtime();
        Date utime = hardware_version_log.getUtime();
