...
public class Finger_userinfo_relation implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_relation newFinger_userinfo_relation(long fur_id, long fu_id, String fingerprint, String finger_veno, String fingerprint_hash, String finger_veno_hash, int is_del, Date ctime, Date utime, String note, String fingerprint_img, String finger_veno_img, String fu_nd) {
    ...
    public void assignment(Finger_userinfo_relation finger_userinfo_relation) {
        ...
        Date ctime = finger_userinfo_relation.getCtime();
        Date utime = finger_userinfo_relation.getUtime();
