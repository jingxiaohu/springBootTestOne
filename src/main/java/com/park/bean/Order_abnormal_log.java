...
public class Order_abnormal_log implements Cloneable , Serializable{
    ...
    public static Order_abnormal_log newOrder_abnormal_log(long id, String order_id, int server_type, int client_type, long money, Date ctime, long pi_id, String area_code, String pi_name, int is_asyn, String note) {
    ...
    public void assignment(Order_abnormal_log order_abnormal_log) {
        ...
        Date ctime = order_abnormal_log.getCtime();
