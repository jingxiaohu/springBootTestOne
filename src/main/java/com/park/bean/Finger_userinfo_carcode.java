...
public class Finger_userinfo_carcode implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_carcode newFinger_userinfo_carcode(long fuc_id, long fu_id, String sfz_number, String car_code, int is_run, int isi_del, Date ctime, Date utime, String note, String fu_nd) {
    ...
    public void assignment(Finger_userinfo_carcode finger_userinfo_carcode) {
        ...
        Date ctime = finger_userinfo_carcode.getCtime();
        Date utime = finger_userinfo_carcode.getUtime();
