...
public class Park_hardware implements Cloneable , Serializable{
    ...
    public static Park_hardware newPark_hardware(long ph_id, long pi_id, String area_code, int type, String ph_mac, String ph_licence, int park_type, Date ctime, Date utime, String ph_loginname, String ph_password, int ph_state, String note, String token, int versioncode) {
    ...
    public void assignment(Park_hardware park_hardware) {
        ...
        Date ctime = park_hardware.getCtime();
        Date utime = park_hardware.getUtime();
