...
public class User_moneyback implements Cloneable , Serializable{
    ...
    public static User_moneyback newUser_moneyback(long um_id, long ui_id, String order_id, long pi_id, Date ctime, Date utime, int um_money, String car_code, String run_url, int um_state, int check_state, long admin_userid, String note, String area_code, int type, String content, int is_rent, String check_content, String pi_name) {
    ...
    public void assignment(User_moneyback user_moneyback) {
        ...
        Date ctime = user_moneyback.getCtime();
        Date utime = user_moneyback.getUtime();
