...
public class Etc_userinfo implements Cloneable , Serializable{
    ...
    public static Etc_userinfo newEtc_userinfo(long eu_id, String eu_nd, long ui_id, String ui_nd, String name, String sfz_number, String sfz_img_url, String bank_card_number, int bank_type, int is_sign, String sign_ip, Date ctime, Date utime, Date signtime, Date discard_time, String note, String ui_tel, int is_default, String orderid, int verify_sign, int is_del) {
    ...
    public void assignment(Etc_userinfo etc_userinfo) {
        ...
        Date ctime = etc_userinfo.getCtime();
        Date utime = etc_userinfo.getUtime();
        Date signtime = etc_userinfo.getSigntime();
        Date discard_time = etc_userinfo.getDiscard_time();
