...
public class Pda_userinfo implements Cloneable , Serializable{
    ...
    public static Pda_userinfo newPda_userinfo(long pui_id, String name, int age, int sex, String address, String tel, String link_tel, long pi_id, String area_code, long pda_id, String mac, Date ctime, Date utime, String note, String loginname, String password, int state) {
    ...
    public void assignment(Pda_userinfo pda_userinfo) {
        ...
        Date ctime = pda_userinfo.getCtime();
        Date utime = pda_userinfo.getUtime();
