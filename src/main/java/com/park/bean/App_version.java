...
public class App_version implements Cloneable , Serializable{
    ...
    public static App_version newApp_version(long id, String cav_version, String cav_version_external, int cav_version_code, Date ctime, String content, String cav_md5, String android_url, String ios_url, int is_forced, String note, int type) {
    ...
    public void assignment(App_version app_version) {
        ...
        Date ctime = app_version.getCtime();
