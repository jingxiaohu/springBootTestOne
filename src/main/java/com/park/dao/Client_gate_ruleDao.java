...
public class Client_gate_ruleDao extends BaseDao{
    ...
    private  String[] carrays ={"cgr_id","client_ruleid","pi_id","area_code","group_id", "com/park/type","money","state","str_json","intro","permit_time","ctime","utime","client_loginname","note","is_del"};
