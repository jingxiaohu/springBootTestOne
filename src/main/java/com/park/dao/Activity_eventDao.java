...
public class Activity_eventDao extends BaseDao{
    ...
    private  String[] carrays ={"id", "com/park/type","ui_id","ui_nd","pi_id","pi_name","area_code","car_code","order_type","orderid","ai_id","money","ctime","state","utime","ai_money","note","md5","send_unit","act_type","method_name","pay_source"};
