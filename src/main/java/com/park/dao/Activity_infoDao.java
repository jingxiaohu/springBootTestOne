...
public class Activity_infoDao extends BaseDao{
    ...
    private  String[] carrays ={"ai_id","title","intro","money", "com/park/type","starttime","endtime","ctime","utime","admin_loginname","admin_id","partner","people_num","note","state","pi_id","area_code","pc_id","weight","pi_name","img","img_jump_url","coupon_endtime"};
