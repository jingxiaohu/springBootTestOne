...
public class User_payDao extends BaseDao{
    ...
    private  String[] carrays ={"id","order_id","transaction_id", "com/park/type","version_code","system_type","return_url","ui_id","ui_nd","money","act_type","ctime","utime","etime","state","ip","referer","subject","note","car_order_id","tel","escape_orderids"};
