...
public class Pda_punch_cardDao extends BaseDao{
    ...
    private  String[] carrays ={"ppc_id","nd","pi_id","area_code","pu_id","pu_nd","mac", "com/park/type","ontime","offtime","loginname","is_clearing","ctime","utime","worker_name","worker_no","pda_user_id","note"};
