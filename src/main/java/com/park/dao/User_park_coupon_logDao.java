...
public class User_park_coupon_logDao extends BaseDao{
    ...
    private  String[] carrays ={"upcl_id","upc_id","ui_id","ui_nd","pc_id","money","discount","high_money","upc_type","end_time","upc_state","ctime","utime","send_unit","ai_id","state","note", "com/park/type","rtime","accept_ui_id","accept_ui_nd"};
