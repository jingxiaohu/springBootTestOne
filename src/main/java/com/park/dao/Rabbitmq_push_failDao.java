...
public class Rabbitmq_push_failDao extends BaseDao{
    ...
    private  String[] carrays ={"rpf_id","rpf_nd","server_code", "com/park/type","content_json","persistent_state","ctime","utime","fail_count","state","name","note","exchange_name","routing_key","host_name","content_md5"};
