...
public class Merchant_parkinfo_monthfree_logDao extends BaseDao{
    ...
    private  String[] carrays ={"id","pu_id","pi_id","area_code","car_code","money","car_type","car_code_color","car_color","start_time_str","end_time_str", "com/park/type","ctime","utime","note"};
