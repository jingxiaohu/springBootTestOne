...
public class Park_hardwareDao extends BaseDao{
    ...
    private  String[] carrays ={"ph_id","pi_id","area_code", "com/park/type","ph_mac","ph_licence","park_type","ctime","utime","ph_loginname","ph_password","ph_state","note","token","versioncode"};
