...
public class Random_coupon_logDao extends BaseDao{
    ...
    private  String[] carrays ={"rcl_id","nd","car_code","money","upc_id", "com/park/type","pi_id","pi_name","area_code","orderid","order_type","partner","ctime","note","ai_id","ui_id","ui_nd","ae_id","send_unit","act_type","pay_source"};
