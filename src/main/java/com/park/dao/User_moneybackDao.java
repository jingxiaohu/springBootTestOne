...
public class User_moneybackDao extends BaseDao{
    ...
    private  String[] carrays ={"um_id","ui_id","order_id","pi_id","ctime","utime","um_money","car_code","run_url","um_state","check_state","admin_userid","note","area_code", "com/park/type","content","is_rent","check_content","pi_name"};
